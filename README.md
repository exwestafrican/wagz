...
## Database
We use postgresql14 to install, do the following
...
```
## Migrations
We use prisma to generate migrations. Here are some of the steps to achieve this

1. Update the `schema.prisma` file with new schema of schema changes.
...
- Locally emails can be viewed at http://127.0.0.1:54324 when Supabase is running locally.
- In production emails are sent via an SMTP server


### Setup FAQ
- Permissions denied error you can run the following
