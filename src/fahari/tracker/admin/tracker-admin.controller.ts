...
import { RegisterDeviceDto } from '@/fahari/tracker/dto/register-device.dto';
import { RotateDeviceApiKeyDto } from '@/fahari/tracker/dto/rotate-device-api-key.dto';
import {
  DeviceResponseDto,
  RegisteredDeviceResponseDto,
  toDeviceResponse,
  toRegisteredDeviceResponse,
} from '@/fahari/tracker/dto/device-response.dto';
