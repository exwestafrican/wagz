...
} from '@/envoye/conversations/dto/conversation-response.dto';
...
import { ListConversationsQueryDto } from '@/envoye/conversations/dto/list-conversations-query.dto';
import { ConversationMetadataResponseDto } from '@/envoye/conversations/dto/conversation-metadata-response.dto';
import { Conversation, Teammate } from '@/generated/prisma/client';
import { ChatHistoryQueryDto } from '@/envoye/conversations/dto/chat-history-query.dto';
import {
  ChatHistoryDto,
  toChatHistoryDto,
} from '@/envoye/conversations/dto/chat-history.dto';
import { isSame } from '@/common/utils';
import { MessagesSinceQueryDto } from '@/envoye/conversations/dto/messages-since-query.dto';
import { MarkAsReadDto } from '@/envoye/conversations/dto/mark-as-read.dto';
